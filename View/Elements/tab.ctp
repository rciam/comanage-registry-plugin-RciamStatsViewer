        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box">
                    ...
                    <div class="lineChart" id="<?php print Inflector::pluralize($prefix); ?>loginsDashboard">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="box">
                    ...
                    <div class="pieChart" id="<?php print $prefix; ?>SpecificChart"></div>
                </div>
                <div class="dataTableContainer" id="<?php print $prefix; ?>SpecificDataTableContainer"></div>
            </div>
        </div>
        <!-- ./col -->
    </div>
